  ...
  computed: {
    time: function () {
      ...
      if (minutes >= 0 && minutes < 13) {
        const havas = document.querySelector('#Capa_3');
    ...
    time2() {
      ...
      if (minutes >= 0 && minutes < 13) {
        const kia = document.querySelector('#Capa_1');
        kia.style.fill = 'green';
      } else if (minutes >= 13 && minutes < 16) {
        const kia = document.querySelector('#Capa_1');
        kia.style.fill = 'orange';
      } else if (minutes >= 16) {
        const kia = document.querySelector('#Capa_1');
        kia.style.fill = 'red';
      }
    ...
    time3() {
      ...
      if (minutes >= 0 && minutes < 12) {
        const hyundai = document.querySelector('#Capa_2');
        hyundai.style.fill = 'green';
      } else if (minutes >= 12 && minutes < 16) {
        const hyundai = document.querySelector('#Capa_2');
        hyundai.style.fill = 'orange';
      } else {
        const hyundai = document.querySelector('#Capa_2');
        hyundai.style.fill = 'red';
      }
